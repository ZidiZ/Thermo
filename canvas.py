import sys,time,os,random, math  #cPickle,
import traceback
import pygame   #thread (is it even used in the py?)
...
class Canvas:
    ...
    def init_pygame(self, w, h): 
        ...
        self.default_font = pygame.font.Font(default_font_name, 24)
    ...
    def __init__(self, size=(800,600), draw_fn=None, tick_fn=None, event_fn=None,fps=60):    
